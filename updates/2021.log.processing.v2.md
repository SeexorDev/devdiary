...
#### ⚊ fix too mutch recursion
-	[![](https://img.shields.io/badge/--FF00FF.svg)]()
	[![](https://img.shields.io/badge/--F1F1F1.svg)]()
	[![](https://img.shields.io/badge/--F1F1F1.svg)]()<br>
	In un device viene riscontrato l'errore di memoria terminata.<br>
	Precisamente è stato rilevato durante:<br>
	&nbsp;<br>
	- checkfield -> formcorrector.js:171<br>
	- formanalizer -> formcorrector.js:36<br>
	&nbsp;<br>
	- setMaker -> k-extra.js:312<br>
	- start_composer  -> k-extra.js:366<br>
	- start_composer -> k-extra.js:340<br>
	- compose_lines_data -> k-extra.js:366<br>
	- compose_ex_data -> k-extra.js:412<br>
...
[FREEZE / IDEE / PROSSIMA VERSIONE / SOLO COME APPUNTO ]
- risolvere il bug memory stack scoperto da kristi;
- passare a nuova versione del framework, ex kimera 3;
- costruire una pagina di "system checks" adatta ai checks da fare su seexor in generale, anche per loop bruteforce dei prodotti.
	- "system checks": "esiste metodo -probabilmente si- per capire se quel link è ancora attivo o no e metterlo in una lista. Una warning list dei prodotti per dire."
