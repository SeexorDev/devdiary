...
[filejam resouce](https://github.com/SeexorDev/diary-log/raw/main/ttb/2022.02.11.ttb.upgrade.co-guard.resources/Seexor%20API%20CO-GUARD%20Scheme.jam)

<br>Altro:<br>

- Bisognerà fare un un riepilogo e uno stampa xml per caricare i prodotti poi su dashbord coguard? <br> > _SI, sarà necessaria un pagina, script ed automatismi server dedicati_ <br>

- Esiste un metodo rapido e più economico senza tracciamento? <br> > _NO, in assenza di tracciamento non sarà possibile paragonare cosa è stato stampato e cosa è da stampare o eventuali errori_<br>

- E' necessario inserire sia ean che sku? o uno basta? <br> > E' necessario inserire almeno uno dei due; non sembra necessario che sia veritiero il codice.<br>

- Sarà necessario espandere il database? <br> > _NON PROPRIO, fino a prova contraria sarà necessaria l'espansione del prodotto singolo e dei codici prodotto._
 
- Servono nuove API? <br> > _SI, sarà necessario costruire un'espansione API._
...
2. **visualizza lista prodotti**<br>
   ...
   | code            | alphanumerico              | Codice prodotto o codice per CO-GUARD       |
   ...
   <br>
   Questo catalogo verrà confrontato con quello di co-guard per l'eliminazione e l'aggiornamento dei prodotti seexor rispetto ad ogni xml in co-guard (che in co-guard sembra essere un indice specifico) ed il suo aggiornamento. Si ipotizza dunque un Init_list, all'apertura o su richiesta in pagina ed un possibile [exec in cron job](https://stackoverflow.com/questions/4558601/how-can-i-make-my-php-script-run-at-a-certain-time-everyday)
