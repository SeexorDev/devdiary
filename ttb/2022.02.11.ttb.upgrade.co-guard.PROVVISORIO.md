...
> _SI, sarà necessario costruire un'espansione API e, forse, un espansione anche per i codici prodotto._<br>
 <br>
 _api : chiamate dedicate alla patch: 
    - aggiorna catalog-status
    - aggiorna catalog-pending
    - aggiorna catalog-warning
    - aggiorna catalog-date
    - aggiorna catalog-xmllink
 <br>
 _api: chiate in ricerca_
